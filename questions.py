questions = [
    ["What does the \'19\' in \'COVID-19\' refer to?\n\
        True: The coronavirus and the disease it causes were identified in 2019.\n\
            False: There are 10 symptoms of coronavirus disease", True, 
    ...
    ["When is it safe to be closer than 6 feet to another person who is not sick with COVID-19?\n\
        True: When you have already had COVID-19\n\
            False: When the person normally lives with you.", False,
    ...
    ["What is the safest way to celebrate your birthday during the COVID-19 pandemic?\n\
        True: Having a virtual party using an online conferencing app.\n\
            False: Sharing a meal with relatives only.", True, 
    ...
    ["Can washing your hands protect you from COVID-19? \n\
        True: Yes - only if you use a strong bleach\n\
            False: Yes - normal soap and water or hand sanitizer is enough", False, 
    ...
    ["What is herd immunity\n\
        True: When a large group of people develop a resistance to an illness.\n\
            False: When people in the same group all act the same way.", True, 
            "Herd immunity is when a large group of people develop a resistance to an illness. Most experts agree that herd immunity is not a good way of combating COVID-19 unless it is coupled with a vaccine."],
    ["What is contact tracing? \n\
        True: It\'s a process used to track all the people a COVID-19 patient has been in contact with.\n\
            False: It\'s a platform to keep in touch with your friends during the pandemic.", True, 
            "Contact tracing is a process used to track all the people a COVID-19 patient has been in contact with."],
    ["How long does the novel coronavirus survive outside the body?\n\
        True: Several hours to days\n\
            False: A week in the air and on surfaces", True, 
            "The virus that causes Covid-19 is stable for several hours in tiny floating particles, known as aerosols, and up to two to three days on plastic and stainless steel, U.S. researchers showed. A study published in the New England Journal of Medicine in March concluded that the novel coronavirus can survive four hours on copper, 24 hours on cardboard, 48 hours on stainless steel and 72 hours on plastic."],
    ["If you think you’ve been exposed to COVID-19, when should you get tested?:\n\
        True: Right away\n\
            False: 4-8 days after or as directed by Public Health", False, 
    ...
    ["What are the best ways to regain strength if you\'ve been affected by COVID-19?:\n\
        True: A combination of strength and aerobic activity\n\
            False: Prolonged bed rest", True, 
            "Being ill, and prolonged bed rest, can weaken muscles and endurance. Start slowly, but focus on building up aerobic capacity through activities you enjoy, like walking, running, swimming or cycling. For strength training, you can use weights, body resistance or even weighted items you might already have at home, like water bottles. Try to build up the amount of time and resistance in a slow but steady pace."],
]
