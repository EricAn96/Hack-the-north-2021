questions = [
    ...
    A: The coronavirus and the disease it causes were identified in 2019.\n\
    B: There are 10 symptoms of coronavirus disease", True, 
    ...
    B: When the person normally lives with you.", False,
    ...
    B: When people in the same group all act the same way.", True, 
    ...
    A: It\'s a process used to track all the people a COVID-19 patient has been in contact with.\n\
    B: It\'s a platform to keep in touch with your friends during the pandemic.", True, 
    ...
    B: A week in the air and on surfaces", True, 
